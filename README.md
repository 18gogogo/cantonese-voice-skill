...
✅ **解決方案**：系統已實現雙重保護機制（v1.5）
1. **超時保護**：50 秒自動超時，返回文字回應
2. **自動截斷**：>9 字自動截斷（N100 CPU 實測推斷）
...
### 語音音量過小
⚠️ **常見問題**：語音回應的 .wav 音量太小，很細聲

✅ **解決方案**：系統已添加數字增益提升（v1.6.0）| 音量等級 | dB 範圍 | 當前設定 |
|---------|--------|---------|
| **適中** | -35 ~ -20 dB | **6 倍增益（-25.8 dB）** ✅ |

**音量對比**:
- 原始：-53.3 dB（很小聲）
- 6 倍增益：-25.8 dB（適中，+27.5 dB）

詳見 [SETTINGS.md](SETTINGS.md) 了解完整音量增益設定。
...
**最後更新**: 2026-02-11 19:53
**版本**: v1.6.0
**重要更新**: 音量增益調整（6 倍，+27.5 dB 提升）

## 📄 更新日誌
完整的更新日誌請查看 [CHANGELOG.md](CHANGELOG.md)